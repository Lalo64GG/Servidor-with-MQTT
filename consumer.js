...
const consumer = mqtt.connect("mqtt://broker.hivemq.com");
...
io.on("connection", (socket) => {
  ...
  consumer.subscribe("arquitectura/salida");
  ...
  consumer.on("message", (topic, message) => {
    ...
    console.log(chalk.blue("Mensaje recibido en el topic: ") + chalk.rgb(0, 164, 223)(msg));
